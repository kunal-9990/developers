<footer class="footer">
    {{-- <div class="container">
        <div class="row">
            <div class="col-sm-4"><a href="https://www.caseware.com"><img src="/img/CaseWare_logo_RGB_horz_White.png" class="footerlogo" alt="CaseWare logo" width="280"></a></div>
            <div class="col-sm-4"><p class="">Copyright © 2017 CaseWare International</p></div>
    ...
    <div class="container">
        ...
        <p class="">Copyright © 2020 CaseWare International</p>
